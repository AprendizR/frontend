...
export function NotaFiscalItem({ nota, onAtualizar }: Props) {
    ...
    return (
      ...
      ${nota.entregue ? statusColors.border : 'border-gray-300'}
      ${nota.entregue ? statusColors.bg : 'bg-white'}
    `}>
            {/* Linha principal */}
            <div className="flex items-center gap-4">
                ...
                <input
                    type="checkbox"
                    checked={nota.entregue}
                    onChange={handleCheckboxChange}
                    disabled={nota.entregue}
                    className={`
            w-6 h-6 accent-green-500
            ${nota.entregue ? 'cursor-not-allowed' : 'cursor-pointer'}
          `}
                />
                ...
                <button
                    ...
                    disabled={carregandoOcorrencias}
                    className={`
